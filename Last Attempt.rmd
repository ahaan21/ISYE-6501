...
**The correct way as homework asks**
...
for (k in 1:50){
   ...
   for (i in 1:nrow(data)) {
    ...
    #final_num <-  final_num + round(fitted.values(kknn_model))
    if (fitted.values(kknn_model) >= 0.5) {final_num <- final_num + 1}
...
Based on the above, the optimal k = 24 or 25, both with a sum of 307 out of 654, meaning it correctly classified 46%. 
...
Unforunately, this was not much of an improvement, but still a slight improvment! 
